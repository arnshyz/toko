    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm md:p-6">
        ...
        >
          ...
          <button className="rounded-full bg-sky-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-400 md:col-span-2">
            Simpan Produk
          </button>
        </form>
      </div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <form method="POST" action={`/api/seller/products/update/${product.id}`}>
                    ...
                    <button className="w-full rounded-full bg-sky-500 px-4 py-2 text-sm font-semibold text-white shadow-sm">
