            ...
            >
              <header className="flex items-start justify-between">
                ...
                <Link
                  ...
                  className="rounded-full bg-orange-100 px-4 py-2 text-xs font-semibold text-orange-700 transition hover:bg-orange-200"
                >
                  Lihat Produk
                </Link>
              </header>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.subCategories.map((sub) => (
                      <Link
                        ...
                        className="rounded-full border border-dashed border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition hover:border-orange-200 hover:text-orange-600"
                      >
                        {sub.name}
                      </Link>
                    ))}
