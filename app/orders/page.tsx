              ...
              <article key={order.orderCode} className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="text-right text-sm text-gray-600">
                    <p className="font-medium text-gray-900">{PAYMENT_LABELS[order.paymentMethod]}</p>
                    <p className="text-xs">Pengiriman: {order.courier}</p>
                    <button
                      type="button"
                ...
                <div className="space-y-3 rounded-lg border border-gray-100 bg-gray-50 p-4">
                  {order.items.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="flex flex-wrap items-start justify-between gap-3 border-b border-dashed border-gray-200 pb-3 last:border-b-0 last:pb-0"
                      >
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-md border border-orange-200 bg-orange-50 px-4 py-2 text-sm font-semibold text-orange-600 transition hover:border-orange-300 hover:bg-orange-100"
                  >
                    Lihat detail pesanan lengkap
                  </Link>
                  <p className="text-xs text-gray-500">Simpan kode ini untuk memantau perkembangan pesanan Anda.</p>
                </div>
              </article>
            );
          })}
